...
class OdoInfo {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.bool(obj.BallIsHolding, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.BallIsHolding = _deserializer.bool(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return '8582fa9c5471801c91b381b70caabb2f';
  }
