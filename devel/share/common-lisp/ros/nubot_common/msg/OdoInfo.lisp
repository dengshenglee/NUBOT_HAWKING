...
(cl:defmethod angle-val ((m <OdoInfo>))
...
(cl:defmethod BallIsHolding-val ((m <OdoInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nubot_common-msg:BallIsHolding-val is deprecated.  Use nubot_common-msg:BallIsHolding instead.")
  (BallIsHolding m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <OdoInfo>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'angle))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:if (cl:slot-value msg 'BallIsHolding) 1 0)) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <OdoInfo>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:setf (cl:slot-value msg 'BallIsHolding) (cl:not (cl:zerop (cl:read-byte istream))))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<OdoInfo>)))
  ...
  "8582fa9c5471801c91b381b70caabb2f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'OdoInfo)))
  "Returns md5sum for a message object of type 'OdoInfo"
  "8582fa9c5471801c91b381b70caabb2f")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<OdoInfo>)))
  ...
  (cl:format cl:nil "Header  header~%float32 Vx~%float32 Vy~%float32 w~%float32 angle~%bool    BallIsHolding~%bool    RobotStuck~%bool    PowerState~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'OdoInfo)))
  "Returns full string definition for message of type 'OdoInfo"
  (cl:format cl:nil "Header  header~%float32 Vx~%float32 Vy~%float32 w~%float32 angle~%bool    BallIsHolding~%bool    RobotStuck~%bool    PowerState~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
