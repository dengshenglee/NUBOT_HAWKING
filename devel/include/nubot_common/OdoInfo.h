...
struct OdoInfo_
{
  ...
  _angle_type angle;
   ...
   typedef uint8_t _BallIsHolding_type;
...
struct MD5Sum< ::nubot_common::OdoInfo_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x8582fa9c5471801cULL;
  static const uint64_t static_value2 = 0x91b381b70caabb2fULL;
};
...
struct Printer< ::nubot_common::OdoInfo_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nubot_common::OdoInfo_<ContainerAllocator>& v)
  {
    ...
    Printer<uint8_t>::stream(s, indent + "  ", v.BallIsHolding);
    s << indent << "RobotStuck: ";
